...
export default function PosterEditor() {
  ...
  useEffect(() => {
    ...
    if (logos.length > 0) {
      ...
      logos.forEach((logo, index) => {
        ...
        const spacing = 40;
        const totalSpacing = (totalLogos > 1) ? (spacing * (totalLogos - 1)) : 0;
        ...
        const totalWidthOfAllLogos = (finalLogoWidth * totalLogos) + totalSpacing;
  ...
  function handleLogoUpload(e: ChangeEvent<HTMLInputElement>) {
    ...
    const newLogo: LogoState = {
      ...
      logoHorizontalOffset: 0,
      logoVerticalOffset: 0,
      logoRadius: 15, // Default to 15px rounded corners
      backgroundType: 'original',
      logoPlateHorizontalPadding: 15,
      logoPlateVerticalPadding: 15,
      logoPlateRadius: 15, // Default to 15px rounded corners for white plate
    };
                  ...
                  {!selectedLogo ? (
                    ...
                    <>
                      ...
                      <InputGroup
                        ...
                        unit="px"
                        onReset={() => updateSelectedLogo({ logoRadius: 15 })} // Note: Default value is 15px now
                        isDefault={selectedLogo.logoRadius === 15}
                      >
                  ...
                  <>
                    ...
                    <Section title="Logo Backdrop">
                      ...
                      <InputGroup
                        ...
                        unit="px"
                        onReset={() => updateSelectedLogo({ logoPlateRadius: 15 })} // Note: Default value is 15px now
                        isDefault={selectedLogo.logoPlateRadius === 15}
                      >
